...
- FCI. Computation, Causation and Discovery, chapter
An Algorithm for Causal Inference in the Presence of Latent Variables and Selection Bias, pp. 211 - 252. MIT Press. 
...
- IDA. Estimating High-Dimensional Intervention EFFects from Observational Data. Annals of Statistics, 37, 3133-3164.

## PC
### Assumption
- Without hidden and selection variables.
- For the following, we only deal with "faithful" distributions. Definition: List of
conditional independencies perfectly matches the list of d-separation relations of some DAG; such distributions are called faithful. (It's majority in the sense that the set of unfaithful distributions has Lebesgue measure zero.)
### Rationale
### Pseudocode
### Result
